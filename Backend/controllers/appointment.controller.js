...
exports.addAppointment = async (req, res) => {
    ...
    try {
        ...
        sendEmail(emailTemplate.appointmentSuccess(user.name, lawyer.name, payload.appointment_date.date, payload.time, payload.type))
...
exports.deleteAppointment = async (req, res) => {
    ...
    try {
        ...
        sendEmail(emailTemplate.appointmentRejected())
