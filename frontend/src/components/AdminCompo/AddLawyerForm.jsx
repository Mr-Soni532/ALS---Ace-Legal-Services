...
import "../AdminCompo/AddLawyerForm.css";
...
const AddLawyerForm = () => {
    ...
    const submitForm = () => {
        ...
        setFirstName(""); setEmail(""); setAddress(""); setImage(""); setNumber(null); setNumber("");
        setSkill1(""); setSkill2(""); setSkill3(""); setSkill4(""); setExperience(""); setRank(null);
        setBio(""); setPrice(null); setPrice(""); setLanguage1(""); setLanguage2(""); setLanguage3("");
        setRating(""); setGender(""); setProfession(""); setRank(null);
    }
    ...
    return (
        <div className="formContainer">
            ...
            <div>
                <img src="/Images/Signup/lawyerpng.jpg" style={{ clipPath: "circle()" , width:'30%'}} alt="Admin_img" />
                <h1>Add Lawyer</h1>
            </div>
