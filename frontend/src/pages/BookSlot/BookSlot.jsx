...
const BookSlot = () => {
    ...
    const [availableSlot, setAvailableSlot] = useState([true,false,true,false]);
    ...
    function getAvailableSlots(){
        ...
        let appointmentByYear = appointmentData.filter(el => el.year === selectedDate[0])
        let appointmentByMonth = appointmentByYear.filter(el => el.month === selectedDate[1])
        let appointmentByDay = appointmentByMonth.filter(el => el.day === selectedDate[2])
