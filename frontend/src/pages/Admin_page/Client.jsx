...
import DetailsComUser from "../../component/AdminCompo/userDetails";
import UserContext from "../../context/Admin_page/userFunction/userContext";
import "../../utlis/admin_css/user.css"
...
const UserDetails  = () =>{
    ...
    return (<div>
        ...
        <div >
            ...
            <>
            <div className="contentConatiner"><DetailsComUser users={sliceTodos()} deletEele={deletEele}/></div>
